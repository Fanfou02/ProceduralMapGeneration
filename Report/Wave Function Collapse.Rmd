...
Once we had our differents pieces of the puzzle, we needed to write down rules to define which block can be placed next to each other taking in account the rotation and the symmetry of each piece. We write more than 200 rules to obtain the models shown in the results part.
