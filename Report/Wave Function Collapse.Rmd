...
The main difficulty arised when we try to render individually each cube. With over 300k cubes in the scene, we struggled to keep a stable number of frames per second when moving the camera.
